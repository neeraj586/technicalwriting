...
categories: [tools, ai]
tags: [ai tools, technical writing, productivity, documentation]
author: neeraj
---
...
- **[Grammarly](https://www.grammarly.com/)**: Now comes with AI features to humanise content, proofread, and more.
- **[ProWritingAid](https://prowritingaid.com/)**: Slightly cheaper than Grammarly and works in a similar way. Offers more features geared towards creative writing.
...
- **[Granola](https://www.granola.ai/)**: Can be started anytime, even when you are already talking to someone. Creates very good AI notes. No need to invite it to the meeting.
- **[Otter.ai](https://otter.ai/)**: Needs to be invited to the meeting. Listens and generates detailed AI notes.
...
- **[Product Hunt](https://www.producthunt.com/)**: Good for tracking new documentation and AI tools.
- **[There Is An AI For That](https://theresanaiforthat.com/)**: Lists a large number of AI tools across categories.
